...
export default function SuccessPage() {
  ...
  return (
    <main className="min-h-[80vh] pt-24 pb-20 px-4 md:px-6 flex flex-col items-center justify-center overflow-hidden relative w-full">
      ...
      <RevealWrapper delay={100} className="w-full max-w-2xl relative z-10">
        <div className="glass-card rounded-[2.5rem] p-10 md:p-16 border border-blue-500/20 bg-[#080808]/80 shadow-[0_0_80px_rgba(0,163,255,0.1)] text-center relative overflow-hidden flex flex-col items-center">
          ...
          <div className="space-y-3 mb-12">
            ...
            <p className="text-gray-400 font-mono text-xs md:text-sm uppercase tracking-widest leading-relaxed max-w-md mx-auto pt-2">
              Lead Engineer Rudi Mouton has been notified. Your request will be reviewed within standard operational parameters.
            </p>
          </div>
