...
import { ArrowRight, Mail, MapPin, Phone, ShieldCheck, Terminal, Send, Lock } from "lucide-react";

export const metadata = {
  title: "Secure Communications | Takumi Tech",
  description: "Establish a direct, encrypted communication link with the Takumi Tech central command node.",
};
    ...
    <div className="w-full flex flex-col items-center justify-start pt-12 md:pt-20 pb-24 relative">
      ...
      <section className="relative w-full max-w-4xl mx-auto text-center px-4 mb-20 z-10">
        ...
        <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase mb-6 leading-tight text-white">
          Establish <br />
          <span className="text-gradient drop-shadow-[0_0_30px_rgba(34,211,238,0.3)]">Comms Link</span>
        </h1>
      ...
      <section className="w-full max-w-6xl mx-auto px-4 sm:px-6 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="glass-card p-8 rounded-[2rem] flex flex-col group hover:border-white/20 transition-all duration-300">
            ...
            <div className="glass-card p-8 rounded-[2rem] flex flex-col group hover:border-white/20 transition-all duration-300">
              ...
              <a href="tel:+27123456789" className="text-lg font-black text-white hover:text-emerald-400 transition-colors uppercase tracking-wider">
                +27 (0) 12 345 6789
              </a>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="glass-card rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden h-full flex flex-col border-cyan-500/20">
              ...
              <form className="flex flex-col flex-grow gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2">
                    ...
                    <input 
                      type="text" 
                      required
                      className="w-full bg-[#050505] border border-white/10 rounded-xl px-5 py-4 text-sm font-medium text-white focus:outline-none focus:border-cyan-500/50 focus:bg-white/5 transition-all"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-mono text-gray-500 uppercase tracking-widest">Transmission Level</label>
                  <div className="relative">
                    <select 
                      className="w-full bg-[#050505] border border-white/10 rounded-xl px-5 py-4 text-sm font-medium text-white focus:outline-none focus:border-cyan-500/50 focus:bg-white/5 transition-all appearance-none cursor-pointer"
                      defaultValue="general"
                    >
                      <option value="general">General Architecture Inquiry</option>
                      <option value="hardware">Hardware Sourcing Request</option>
                ...
                <div className="flex flex-col gap-2 flex-grow">
                  ...
                  <textarea 
                    required
                    rows={6}
                    className="w-full h-full bg-[#050505] border border-white/10 rounded-xl px-5 py-4 text-sm font-medium text-white focus:outline-none focus:border-cyan-500/50 focus:bg-white/5 transition-all custom-scrollbar resize-none"
                    placeholder="Enter your system parameters or inquiry here..."
                  />
                </div>
                ...
                <div className="pt-4 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-white/10 mt-2">
                  ...
                  <button 
                    type="submit"
                    className="group relative flex items-center justify-center gap-3 px-10 py-5 bg-cyan-600 text-white font-black uppercase tracking-widest text-xs rounded-xl hover:bg-cyan-500 shadow-[0_0_30px_rgba(34,211,238,0.3)] hover:shadow-[0_0_50px_rgba(34,211,238,0.5)] transition-all ring-1 ring-cyan-400/50 w-full md:w-auto"
                  >
