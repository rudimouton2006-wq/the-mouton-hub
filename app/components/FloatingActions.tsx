  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-end">
      ...
      <Link 
        ...
        className="relative group flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#1EBE5A] rounded-full shadow-[0_0_20px_rgba(37,211,102,0.3)] transition-all duration-300 hover:scale-110"
      >
        {/* Active Pulse Glow */}
      ...
      <Link 
        ...
        className="relative group flex items-center justify-center w-12 h-12 bg-[#0A0A0A] hover:bg-white/10 border border-white/10 hover:border-[#00E5FF]/50 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
      >
