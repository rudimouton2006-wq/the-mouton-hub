...
export default function WhatsAppButton() {
  ...
  // The direct line to the Takumi Tech Lead Engineer
  // Replace with actual business number (include country code, e.g., 27 for ZA)
  const phoneNumber = "27123456789"; 
  const defaultMessage = encodeURIComponent("Initializing Takumi Tech Comms... I have an inquiry regarding your system architecture and sourcing protocols.");
  ...
  return (
    <div 
      className={`fixed bottom-24 lg:bottom-6 right-6 z-[90] transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] ${
