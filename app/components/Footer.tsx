    ...
    <footer className="relative w-full border-t border-white/10 bg-[#030508] pt-16 pb-8 overflow-hidden z-20">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 xl:gap-12 mb-16">
          ...
          {/* 1. BRAND COLUMN */}
          <div className="sm:col-span-2 lg:col-span-3 flex flex-col gap-6 lg:pr-4">
            <Link href="/" className="group flex items-center gap-3 w-fit">
              <div className="w-12 h-12 rounded-xl bg-[#0A0D14] border border-white/10 flex items-center justify-center transition-transform duration-300 group-hover:scale-105 shadow-sm">
                <Terminal className="w-6 h-6 text-gray-300 group-hover:text-[#00E5FF] transition-colors duration-300 shrink-0" />
              </div>
          ...
          {/* 2. NAVIGATION COLUMN */}
          <div className="sm:col-span-1 lg:col-span-2 flex flex-col gap-5">
            ...
            <nav className="flex flex-col gap-4">
              {[
                ...
                <Link 
                  key={index} 
                  href={link.path}
                  className="text-gray-400 text-sm md:text-base font-medium hover:text-white transition-colors w-fit flex items-center gap-3 group"
                >
                  <ArrowRight className="w-4 h-4 text-[#00E5FF] opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 shrink-0" />
                  {link.name}
                </Link>
              ))}
            </nav>
          ...
          <div className="sm:col-span-1 lg:col-span-2 flex flex-col gap-5">
            ...
            <nav className="flex flex-col gap-4">
              <Link 
                ...
                className="text-gray-400 text-sm md:text-base font-medium hover:text-white transition-colors w-fit flex items-center gap-3 group"
              >
                <ShieldCheck className="w-4 h-4 text-gray-500 group-hover:text-[#2563EB] transition-colors shrink-0" />
                Terms of Service
              </Link>
            </nav>
          </div>
          ...
          {/* 4. CONTACT US COLUMN */}
          <div className="sm:col-span-1 lg:col-span-3 flex flex-col gap-5">
            <h3 className="text-white font-bold uppercase tracking-wider text-sm flex items-center gap-2">
              Contact Us
            </h3>
            <div className="flex flex-col gap-5">
              <a 
                ...
                className="group flex items-center gap-3 text-sm md:text-base text-gray-400 hover:text-white transition-colors w-fit"
              >
                <MessageCircle className="w-5 h-5 text-gray-500 group-hover:text-[#25D366] transition-colors shrink-0" />
              ...
              <a 
                ...
                className="group flex items-center gap-3 text-sm md:text-base text-gray-400 hover:text-white transition-colors w-fit mt-1"
              >
                <Mail className="w-5 h-5 text-gray-500 group-hover:text-[#00E5FF] transition-colors shrink-0" />
          ...
          <div className="sm:col-span-1 lg:col-span-2 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-5">
              ...
              <a 
                ...
                className="group flex items-center gap-3 text-sm md:text-base text-gray-400 hover:text-white transition-colors w-fit"
              >
                <Instagram className="w-5 h-5 text-gray-500 group-hover:text-[#00E5FF] transition-colors shrink-0" />
              ...
              <a 
                ...
                className="group flex items-center gap-3 text-sm md:text-base text-gray-400 hover:text-white transition-colors w-fit"
              >
                <Linkedin className="w-5 h-5 text-gray-500 group-hover:text-[#0A66C2] transition-colors shrink-0" />
              ...
              <a 
                ...
                className="group flex items-center gap-3 text-sm md:text-base text-gray-400 hover:text-white transition-colors w-fit"
              >
                <Facebook className="w-5 h-5 text-gray-500 group-hover:text-[#1877F2] transition-colors shrink-0" />
        ...
        <div className="w-full pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-xs sm:text-sm font-bold text-gray-500 uppercase tracking-widest text-center md:text-left">
